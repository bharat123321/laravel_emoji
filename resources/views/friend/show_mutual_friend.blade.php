...
@section('content')
  ...
  <div class="container-fluid">  
    ...
    <a  href="/friend_request" style="color:red;text-decoration: none;"><b style="font-size:20px">&#8592;</b>Back</a>   
     </div> 
  ...
  <?php      $de =  DB::table('posts')->where('block',1)->where('user_id',$mutual_friend)->first();  
  ?>
