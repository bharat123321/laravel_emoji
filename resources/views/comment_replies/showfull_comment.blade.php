...
@section('content')
 ...
 <div class="panel">  
  	   ...
  	   <div class="From_full_image_comment"  id="{{$showcomment->id}}"  style="position: relative;top:-18px;color: gray;cursor: pointer;"><b>Reply</b></div>
      <div class="From_full_image_comment_del"  id="{{$showcomment->id}}" post-video="{{$showcomment->video}}" post-image="{{$showcomment->image}}" style="position: relative;top:-40px;left:50px;color:darkred;cursor: pointer;"><b>Delete</b></div>

  		 @include('comment_replies.commentfull_image')
  		@endforeach
